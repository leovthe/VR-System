...
public class SubmitFormDto {
    ...
    public SubmitFormDto(Long requisitionFormId, String destination, LocalTime timeIn, LocalTime timeOut, LocalDate dateIn, LocalDate dateOut, double fuelIn, double fuelOut, int mileageOut, int mileageIn, String purpose, String vehicleRegistrationNumber, String departmentName, String driverName, Long formId, boolean headofDepartmentApproved, boolean humanResourcesApproved, String currentApprover, String overallStatus, Driver driver) {
